...
export const projects: Project[] = [
  ...
  {
    slug: "rinkhimera-portfolio",
    titleKey: "items.rinkhimeraportfolio.title",
    descriptionKey: "items.rinkhimeraportfolio.description",
    longDescriptionKey: "items.rinkhimeraportfolio.longDescription",
    image: "/images/projects/rinkhimera-portfolio.webp",
    techStack: [
      "Next.js",
      "TypeScript",
      "Prisma",
    ...
    githubUrl: "https://github.com/RinKhimera/rinkhimera-portfolio",
    liveUrl: "https://rinkhimera.vercel.app",
    featured: true,
    featureCount: 5,
    challengeCount: 3,
    screenshots: [],
